import DwenguinoSimulationRobotComponentsMenu from "../socialrobot/dwenguino_simulation_robot_components_menu.js"
import EventBus from "../socialrobot/event_bus.js"
import { EventsEnum } from "../socialrobot/scenario_event.js"
...
/**
 * This class is the abstraction of the generic robot simulator scenario.
 ...
 */
class DwenguinoSimulationScenarioGeneric extends DwenguinoSimulationScenario{
  simulationComponentsMenu = null;
  simulationRobotComponents = null;
  robotComponentsFactory = null;
  backgroundClassName = "";

  // For buzzer which is not an extra robot component TODO in buzzer component
  audioStarted = false;
  prevFreq = 0;
  ...
  resetScenario(){
    if (this.robotComponentsFactory){
      this.robotComponentsFactory.resetGenericRobot();
    }
  }
...
export default DwenguinoSimulationScenarioGeneric;