...
class EnvironmentLamp extends RobotComponent{
    ...
    constructor(){
        ...
        this._activeImageUrl = `${settings.basepath}DwenguinoIDE/img/socialrobot/lamp_active.png`;
        this._inactiveImageUrl = `${settings.basepath}DwenguinoIDE/img/socialrobot/lamp_inactive.png`;
