...
var MSG = {
  ...
  saveBlocksToProfileTooltip: "Sla je blokken op in je account.",
  ...
  setup: "zet klaar",
  loop: "herhaal",
  dwenguino_main_program_structure: "Het eerste stukje code wordt maar een keer uitgevoerd bij het starten van het programma. De code in de 'herhaal' wordt steeds opnieuw herhaald tot het programma stopt (bv. wanneer je de stekker uit het bordje trekt).",
  catDwenguino: "Dwenguino",
  ...
  socialRobotLedmatrixEyePatternSegmentBlock: "op ledmatrix",
  socialRobotLedmatrixClearSegmentBlock: "Maak de ledmatrix leeg",
  socialRobotLedmatrixClearSegmentBlockTooltip: "Maak het gekozen ledmatrix-segment leeg.",
  socialRobotLedmatrixClearDisplayBlock: "Maak de ledmatrix leeg",
  ...
  nameFileToSave: "Geef je programma een naam.",
...
MSG.ledmatrix = {
  ...
  down2: 'Beneden 2',
  down3: 'Beneden 3',
  angryLeft1: 'Boos links 1',
  angryLeft2: 'Boos links 2',
  angryLeft3: 'Boos links 3',
  angryLeft4: 'Boos links 4',
  angryRight1: 'Boos rechts 1',
  angryRight2: 'Boos rechts 2',
  angryRight3: 'Boos rechts 3',
  angryRight4: 'Boos rechts 4',
  sadLeft1: 'Verdrietig links 1',
  sadLeft2: 'Verdrietig links 2',
  sadLeft3: 'Verdrietig links 3',
  sadRight1: 'Verdrietig rechts 1',
  sadRight2: 'Verdrietig rechts 2',
  sadRight3: 'Verdrietig rechts 3',
  evilLeft1: 'Kwaadaardig links 1',
  evilLeft2: 'Kwaadaardig links 2',
  evilRight1: 'Kwaadaardig rechts 1',
  evilRight2: 'Kwaadaardig rechts 2',
  scanHorizontal1: 'Scan horizontaal 1',
  scanHorizontal2: 'Scan horizontaal 2',
  scanHorizontal3: 'Scan horizontaal 3',
  scanHorizontal4: 'Scan horizontaal 4',
  scanVertical1: 'Scan verticaal 1',
  scanVertical2: 'Scan verticaal 2',
  scanVertical3: 'Scan verticaal 3',
  scanVertical4: 'Scan verticaal 4',
  scanVertical5: 'Scan verticaal 5',
  scanVertical6: 'Scan verticaal 6',
  rip1: 'RIP 1',
  rip2: 'RIP 2',
  peering1: 'Turen 1',
  peering2: 'Turen 2',
...
MSG.simulator = {
  ...
  servo: "Servo",
  servoDescription: "Een servomotor kan draaien over een bepaalde hoek tussen 0 en 180 graden. Bij gebruik van het servomotor-blok geef je de gewenste hoek mee in je programma. Er zijn in de toolbox ook blokken voorzien om bv. handjes te laten zwaaien; in deze blokken is de hoek reeds ingesteld.",
  motor: "Motor",
  DCMotorDescription: "Een gelijkstroommotor of dc-motor draait helemaal rond. Je kan zo’n motor gebruiken om de robot te laten rijden. De snelheid en de draaizin van de motor geef je mee in je programma als een getal van -255 t.e.m. 255.",
  scope: "Waarden",
...
MSG.logging = {
  ...
  password: "Password",
  repeatedPassword: "Herhaal wachtwoord",
  enterPassword: "Voeg een wachtwoord in",
